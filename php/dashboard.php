...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Details cargaison <?php echo $cargaison['type']; ?>
        </h2>
        <!-- CTA -->
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    ...
                    <button class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                        En cours
                    </button>
                    <select name="etat" id="">
            ...
            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                ...
                <div>
                    ...
                    <button class="text-lg py-3 px-2 bg-red-400 rounded font-semibold text-gray-700 dark:text-gray-200">
                        Fermer
                    </button>
                    <button class="text-lg py-3 px-2 bg-green-500 rounded font-semibold text-gray-700 dark:text-gray-200">
                        Ouvrir
                    </button>
